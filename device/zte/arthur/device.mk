...
# APNS-XML.CONF / extra things
PRODUCT_COPY_FILES += \
        device/zte/arthur/prebuilt/b08c/etc/apns-conf.xml:system/etc/apns-conf.xml \
        device/zte/arthur/prebuilt/b08c/etc/gps.conf:system/etc/gps.conf \
        device/zte/arthur/prebuilt/b08c/etc/hosts:system/etc/hosts \
        device/zte/arthur/prebuilt/b08c/etc/loc_parameter.ini:system/etc/loc_parameter.ini \
        device/zte/arthur/prebuilt/b08c/etc/LsOmaClientSettings.xml:system/etc/LsOmaClientSettings.xml \
        device/zte/arthur/prebuilt/b08c/etc/OperatorPolicy.xml:system/etc/OperatorPolicy.xml \
        device/zte/arthur/prebuilt/b08c/etc/voicemail-conf.xml:system/etc/voicemail-conf.xml
